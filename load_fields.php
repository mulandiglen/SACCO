...
<div class="row">
    ...
    <p><small>Balance: <b><?php echo number_format($balance, 2) ?></b></small></p>
    <p><small>Total Loan Balance: <b><?php echo number_format($total_balance, 2) ?></b></small></p>
...
<div class="row">
      <div class="card mt-5 px-3 py-4">
        ...
        <div class="media mt-3 pl-2">
            ...
            <input type="number" class="form-control" name="amount" step="any" placeholder="Enter Amount" required="" value="<?php echo isset($amount) ? $amount : '' ?>">
            </div>
                <div class="col-4">
                ...
                <div class="col-3">
                <button type="submit" class="btn btn-success" name="submit" value="pay">Pay</button>
                </div>
              </form>
              <!--bs5 input-->
          </div>
